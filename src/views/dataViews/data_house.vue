 ...
 * @Last Modified time: 2018-06-07 13:58:12
 */
  ...
  data() {
    ...
    return {
      ...
      colModels: [
        ...
        {prop: 'financeEstateAmount', label: '公寓套数(金融房源)', sortable: true, minWidth: '150', align: 'right'},
        {prop: 'financeEstateRoomAmount', label: '公寓间数(金融房源)', sortable: true, minWidth: '150', align: 'right'},
        ...
        {prop: 'financeHostingHouseAmount', label: '分散式套数(金融房源)', sortable: true, minWidth: '150', align: 'right'},
        {prop: 'financeHostingHouseRoomAmount', label: '分散式间数(金融房源)', sortable: true, minWidth: '150', align: 'right'}
      ],
